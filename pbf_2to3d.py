...
boundary = (
    grid_res[0] / screen_to_world_ratio,
    grid_res[1] / screen_to_world_ratio,
    grid_res[2] / screen_to_world_ratio,
)
cell_size = 2.51
...
def render(window, scene, canvas):
    ...
    points_pos[1] = [b[0], -1, 10]

    points_pos[2] = [b[0], -1, 0]
    points_pos[3] = [b[0], 18, 0]

    points_pos[4] = [b[0], 18, 0]
    points_pos[5] = [b[0], 18, 10]

    points_pos[6] = [b[0], 18, 10]
    points_pos[7] = [b[0], -1, 10]
...
def main():
    ...
    camera.position(boundary[0] / 2 + 1 , 10 , -40)  # x, y, z
    camera.lookat(boundary[0] / 2 + 1 , 5 , 0 )
    camera.up(0, 1, 0)
